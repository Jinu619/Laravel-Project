    ...
    <div class="content flex-row-fluid" id="kt_content">
                        ...
                        <div class="d-flex justify-content-between align-items-start flex-wrap mb-2">
                            ...
                            <div class="d-flex flex-column">
                                ...
                                <div class="d-flex align-items-center mb-2">
                                    <a href="#" class="text-gray-900 text-hover-primary fs-2 fw-bolder me-1">{{auth()->user()->fullname}}</a>
                                    <a href="#">
                                ...
                                <div class="d-flex flex-wrap fw-bold fs-6 mb-4 pe-2">
                                    ...
                                    <a href="#" class="d-flex align-items-center text-gray-400 text-hover-primary me-5 mb-2">
                                        ...
                                        <!--end::Svg Icon-->{{auth()->user()->country}}
                                    </a>
        ...
        <div class="card mb-5 mb-xl-10">
            ...
            <div id="kt_account_settings_profile_details" class="collapse show">
                <!--begin::Form-->
                <form  class="form" action="/setting" enctype="multipart/form-data" method="POST">
                    @csrf
                    <!--begin::Card body-->
                    <div class="card-body border-top p-9">
                            ...
                            <div class="col-lg-8">
                                ...
                                <div class="row">
                                    ...
                                    <div class="col-lg-12 fv-row">
                                        <input type="text" name="fname" class="form-control form-control-lg form-control-solid mb-3 mb-lg-0" placeholder="First name" value="{{auth()->user()->fullname}}" />
                                    </div>
                                    <!--end::Col-->
                                </div>
                                <!--end::Row-->
                        ...
                        <div class="row mb-6">
                            <!--begin::Label-->
                            <label class="col-lg-4 col-form-label fw-bold fs-6">Profile Site</label>
                            <!--end::Label-->
                            <!--begin::Col-->
                            <div class="col-lg-8 fv-row">
                                <input type="text" name="website" class="form-control form-control-lg form-control-solid" placeholder="Company website" value="{{auth()->user()->profile_webiste}}" />
                            </div>
                            <!--end::Col-->
                        </div>
                        <!--end::Input group-->
                        ...
                        <div class="row mb-6">
                            ...
                            <div class="col-lg-8 fv-row">
                                <select name="country" aria-label="Select a Country" data-control="select2" data-placeholder="Select a country..." class="form-select form-select-solid form-select-lg fw-bold">
                                    @if(auth()->user()->country != null)<option value="{{auth()->user()->country}}">{{auth()->user()->country}}</option>@else
                                    <option value="">Select a Country...</option>@endif
                        ...
                        <div class="row mb-6">
                            ...
                            <div class="col-lg-8 fv-row">
                                ...
                                @if(auth()->user()->language != null)<option value="{{auth()->user()->language}}">{{auth()->user()->language}}</option>@else
                                    <option value="">Select a Language...</option>@endif
                                    <option data-kt-flag="flags/indonesia.svg" value="Bahasa Indonesia - Indonesian">Bahasa Indonesia - Indonesian</option>
                                    <option data-kt-flag="flags/malaysia.svg" value="Bahasa Melayu - Malay">Bahasa Melayu - Malay</option>
                                    ...
                                    <option data-kt-flag="flags/united-kingdom.svg" value="English">English</option>
                                    ...
                                    <option data-kt-flag="flags/india.svg" value="हिन्दी - Hindi">हिन्दी - Hindi</option>
                        ...
                        <div class="row mb-6">
                            ...
                            <div class="col-lg-8 fv-row">
                                ...
                                @if(auth()->user()->time_zone != null)<option value="{{auth()->user()->time_zone}}">{{auth()->user()->time_zone}}</option>@else
                                    <option value="">Select a Timezone...</option>@endif
            ...
            <div id="kt_account_settings_signin_method" class="collapse show">
                ...
                <div class="card-body border-top p-9">
                    ...
                    <div class="d-flex flex-wrap align-items-center">
                        ...
                        <!--end::Label-->
                        <!--begin::Edit-->
                        <div id="kt_signin_email_edit" class="flex-row-fluid" hidden>
                            <!--begin::Form-->
                            <form id="kt_signin_change_email" action="/changeemail" method="POST" class="form" novalidate="novalidate">
                                @csrf
                                <div class="row mb-6">
                                    <div class="col-lg-6 mb-4 mb-lg-0">
                                        <div class="fv-row mb-0">
                                            <label for="emailaddress" class="form-label fs-6 fw-bolder mb-3">Enter New Email Address</label>
                                            <input type="email" class="form-control form-control-lg form-control-solid" id="emailaddress" placeholder="john@gmail.com" name="emailaddress"  required/>
                                        </div>
                                    </div>
                                    <!-- <div class="col-lg-6">
                                        <div class="fv-row mb-0">
                                ...
                                <div class="d-flex">
                                    ...
                                    <button id="kt_signin_cancel" onclick="changetoold()" type="button" class="btn btn-color-gray-400 btn-active-light-primary px-6">Cancel</button>
                                </div>
                            </form>
                            <!--end::Form-->
                        </div>
                        ...
                        <div id="kt_signin_email_button" class="ms-auto">
                            <button class="btn btn-light btn-active-light-primary" onclick="changeemail()">Change Email</button>
                        </div>
                        <!--end::Action-->
                    </div>
                    <!--end::Email Address-->
                    ...
                    <div class="d-flex flex-wrap align-items-center mb-10">
                        ...
                        <!--end::Label-->
                        <!--begin::Edit-->
                        <div id="kt_signin_password_edit" class="flex-row-fluid" hidden>
                            <!--begin::Form-->
                            <form id="kt_signin_change_password" action="/changepassword" method="POST" class="form" novalidate="novalidate">
                                @csrf
                                <div class="row mb-1">
                                    <div class="col-lg-4">
                                        <div class="fv-row mb-0">
                                ...
                                <div class="d-flex">
                                    ...
                                    <button id="kt_password_cancel" onclick="cancelchangepassword()" type="button" class="btn btn-color-gray-400 btn-active-light-primary px-6">Cancel</button>
                                </div>
                            </form>
                            <!--end::Form-->
                        </div>
                        ...
                        <div id="kt_signin_password_button" class="ms-auto">
                            <button class="btn btn-light btn-active-light-primary" onclick="changepassword()">Reset Password</button>
                        </div>
                        <!--end::Action-->
                    </div>
                    <!--end::Password-->
                ...
                <div class="card-body border-top p-9">
                    ...
                    <div class="py-2">
                        ...
                        <div class="d-flex flex-stack">
                            <div class="d-flex">
                                <img src="https://preview.keenthemes.com/metronic8/demo2/assets/media/svg/brand-logos/google-icon.svg" class="w-30px me-6" alt="" />
                                <div class="d-flex flex-column">
                        ...
                        <div class="d-flex flex-stack">
                            <div class="d-flex">
                                <img src="https://preview.keenthemes.com/metronic8/demo2/assets/media/svg/brand-logos/github.svg" class="w-30px me-6" alt="" />
                                <div class="d-flex flex-column">
                        ...
                        <div class="d-flex flex-stack">
                            <div class="d-flex">
                                <img src="https://preview.keenthemes.com/metronic8/demo2/assets/media/svg/brand-logos/slack-icon.svg" class="w-30px me-6" alt="" />
                                <div class="d-flex flex-column">
...
<script>
    function changeemail(){
        $('#kt_signin_email_edit').attr('hidden',false);
        $('#kt_signin_email').attr('hidden',true);
        $('#kt_signin_email_button').attr('hidden',true);
    }
    function changetoold(){
        $('#kt_signin_email_edit').attr('hidden',true);
        $('#kt_signin_email').attr('hidden',false);
        $('#kt_signin_email_button').attr('hidden',false);
    }

    function changepassword(){
        $('#kt_signin_password_edit').attr('hidden',false);
        $('#kt_signin_password').attr('hidden',true);
        $('#kt_signin_password_button').attr('hidden',true);
    }
    function cancelchangepassword(){
        $('#kt_signin_password_edit').attr('hidden',true);
        $('#kt_signin_password').attr('hidden',false);
        $('#kt_signin_password_button').attr('hidden',false);
    }
</script>
