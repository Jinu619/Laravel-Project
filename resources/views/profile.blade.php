        ...
        <div class="card mb-5 mb-xl-10" id="kt_profile_details_view">
            ...
            <div class="card-body p-9">
                ...
                <div class="row mb-7">
                    ...
                    <!--begin::Col-->
                    <div class="col-lg-8">
                        <span class="fw-bolder fs-6 text-gray-800">{{auth()->user()->fullname}}</span>
                    </div>
                    <!--end::Col-->
                </div>
                <!--end::Row-->
                ...
                <div class="row mb-7">
                    ...
                    <!--begin::Col-->
                    <div class="col-lg-8">
                        <a href="{{auth()->user()->profile_webiste}}" target="_blank" class="fw-bold fs-6 text-gray-800 text-hover-primary">{{auth()->user()->profile_webiste}}</a>
                    </div>
                    <!--end::Col-->
                </div>
                <!--end::Input group-->
