										...
										<div class="card-body">
											...
											<div class="row align-items-center h-100">
												...
												<div class="col-5 pt-10">
													<!--begin::Illustration-->
													<div class="bgi-no-repeat bgi-size-contain bgi-position-x-end h-225px" style="background-image:url('https://preview.keenthemes.com/metronic8/demo2/assets/media/svg/illustrations/easy/5.svg');"></div>
													<!--end::Illustration-->
												</div>
												<!--end::Col-->
											</div>
									...
									<div class="card h-md-100">
										...
										<div class="card-body d-flex flex-column flex-center">
											...
											<div class="mb-2">
												...
												<!--end::Title-->
												<!--begin::Illustration-->
												<div class="flex-grow-1 bgi-no-repeat bgi-size-contain bgi-position-x-center card-rounded-bottom h-200px mh-200px my-5 my-lg-12" style="background-image:url('https://preview.keenthemes.com/metronic8/demo2/assets/media/svg/illustrations/easy/2-dark.svg')"></div>
												<!--end::Illustration-->
											</div>
											<!--end::Heading-->
											<!--begin::Links-->
											...
											<div class="tab-content">
												...
												<div class="tab-pane active" id="kt_timeline_widget_4_tab_day" role="tabpanel" aria-labelledby="day-tab" data-kt-timeline-widget-4-blockui="true">
													<div class="table-responsive pb-10">
														<!--begin::Timeline-->
														<div id="kt_timeline_widget_4_1" class="vis-timeline-custom h-350px min-w-700px" data-kt-timeline-widget-4-image-root="/metronic8/demo2/assets/media/"></div>
														<!--end::Timeline-->
													</div>
												</div>
												<!--end::Tab pane-->
												...
												<div class="tab-pane" id="kt_timeline_widget_4_tab_week" role="tabpanel" aria-labelledby="week-tab" data-kt-timeline-widget-4-blockui="true">
													<div class="table-responsive pb-10">
														<!--begin::Timeline-->
														<div id="kt_timeline_widget_4_2" class="vis-timeline-custom h-350px min-w-700px" data-kt-timeline-widget-4-image-root="/metronic8/demo2/assets/media/"></div>
														<!--end::Timeline-->
													</div>
												</div>
												<!--end::Tab pane-->
												...
												<div class="tab-pane" id="kt_timeline_widget_4_tab_month" role="tabpanel" aria-labelledby="month-tab" data-kt-timeline-widget-4-blockui="true">
													<div class="table-responsive pb-10">
														<!--begin::Timeline-->
														<div id="kt_timeline_widget_4_3" class="vis-timeline-custom h-350px min-w-700px" data-kt-timeline-widget-4-image-root="/metronic8/demo2/assets/media/"></div>
														<!--end::Timeline-->
													</div>
												</div>
												<!--end::Tab pane-->
												...
												<div class="tab-pane" id="kt_timeline_widget_4_tab_2022" role="tabpanel" aria-labelledby="week-tab" data-kt-timeline-widget-4-blockui="true">
													<div class="table-responsive pb-10">
														<!--begin::Timeline-->
														<div id="kt_timeline_widget_4_4" class="vis-timeline-custom h-350px min-w-700px" data-kt-timeline-widget-4-image-root="/metronic8/demo2/assets/media/"></div>
														<!--end::Timeline-->
													</div>
												</div>
												<!--end::Tab pane-->
