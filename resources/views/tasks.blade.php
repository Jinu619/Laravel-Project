                ...
                <div class="card card-flush h-lg-100">
                    ...
                    <div class="card-header mt-6">
                        ...
                        <div class="card-title flex-column">
                            ...
                            <div class="fs-6 text-gray-400">Total {{$pendingtask}} tasks in backlog</div>
                        </div>
                        <!--end::Card title-->
                        <!--begin::Card toolbar-->
                    ...
                    <div class="card-body d-flex flex-column mb-9 p-9 pt-3">
                        ...
                        <div class="d-flex align-items-center position-relative mb-7">
                            ...
                            <!--begin::Details-->
                            <div class="fw-bold">
                                <a href="#" class="fs-6 fw-bolder text-gray-900 text-hover-primary">{{$task->taskname}}</a>
                                <!--begin::Info-->
                                <div class="text-gray-400">Due in {{now()->diffInDays($task->todate)}} day {{now()->diff($task->todate)->h}} hour {{now()->diff($task->todate)->i}} minitue
                                    <a href="#">{{$task->fullname}}</a>
                                </div>
                                <!--end::Info-->
                            </div>
                            <!--end::Details-->
                            ...
                            <!--begin::Menu 1-->
                            <div class="menu menu-sub menu-sub-dropdown w-250px w-md-300px" data-kt-menu="true" id="kt_menu_62b6f481508b8">
                                <!--begin::Header-->
                                <div class="px-7 py-5">
                                    <div class="fs-5 text-dark fw-bolder">Action</div>
                                </div>
                                <!--end::Header-->
                                ...
                                <div class="px-7 py-5">
                                    ...
                                    <div class="mb-10">
                                        ...
                                        <div>
                                            <select class="form-select form-select-solid" name="newstatus" id="newstatus">
                                                <option></option>
                                    ...
                                    <div class="d-flex justify-content-end">
                                        ...
                                        <button type="submit" onclick="changestatus();" class="btn btn-sm btn-primary" data-kt-menu-dismiss="true">Apply</button>
                                    </div>
                                    <!--end::Actions-->
                                </div>
                                <!--end::Form-->
